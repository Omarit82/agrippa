...
class TurnosView{
    ...
    function showTurnos($lista){
        ...
        ?>
        <div class= "vh-50">
            <form method="POST" action="registrar" id="turno" class="nuevoTurno">
                <div>
                    <div class="form-floating m-2 d-flex">
                        <label for="fechaTurno" class="form-label p-2">Fecha</label>
                        <input type="date" class="form-control" id="fTurno" name="fechaTurno">
                    </div>
                </div>
                    ...
                    <div class="dropdown m-2">
                        ...
                        <?php 
                            foreach ($lista as $paciente) {
                                echo '<li class="p-2 listado">'.$paciente->apellido.", ".$paciente->nombre.'</li>';
                            }
                        ?>
                        </ul>
                        <input class="w-100 mt-2 campoPaciente text-center" type="text" name="campoPaciente" id="cPaciente">
                    </div>
                    <div class="dropdown m-2">
                        <button class="btn botonUno dropdown-toggle w-100" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Turno
